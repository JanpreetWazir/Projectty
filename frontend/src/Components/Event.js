...
const Event = forwardRef((props, ref) => {
  const gradientColors = 'to left, #defc7c, #e7fb30, #b3b901';
          ...
          return (
            ...
            >
              ...
              <div className="knowMore">
                <Link
                  to="/form" // Assuming you have a route for the form at /form
                  className="w-[130px] h-[40px] px-3 py-2 font-semibold rounded-lg cursor-pointer"
                  style={{
